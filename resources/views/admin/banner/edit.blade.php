                            ...
                            @foreach($update_fields as $labels => $fields)
                                    @if($fields=='image' || $fields=='logo')
                                        <div class="white-box">
                                            ...
                                            <input name="{{$fields}}" type="file" id="input-file-now-custom-1" class="dropify" data-default-file="{{asset('images/'.$route.'/'.$row->image ? 'images/'.$route.'/'.$row->image : 'images/'.$route.'/'.$row->logo) }}"/>
