                                    ...
                                    @endforeach
                                        @if($row->image==null)
                                            <td data-toggle="modal" data-target="#myModal{{$row->id}}"><img
                                                        class="img-preview" src="{{ asset('images/user/default.png') }}"
                                        ...
                                        @else
                                            <td data-toggle="modal" data-target="#myModal{{$row->id}}"><img
                                                        class="img_preview" src="{{ asset('images/user/'.$row->image) }}"
                                                        style="height: 85px;width: 85px; border-radius: 50%"></td>
                                            <div id="myModal{{$row->id}}" class="modal fade" role="img">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <img data-toggle="modal" data-target="#myModal{{$row->id}}"
                                                                 class="img-preview"
                                                                 src="{{ asset('images/user/'.$row->image) }}"
                                                                 style="max-height: 500px">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default"
                                        ...
                                        @endif
{{--                                    @php--}}
{{--                                        $role_id=\App\Models\AdminRole::where('admin_id',$row->id)->value('role_id');--}}
{{--                                        $role_name=\App\Models\Role::where('id',$role_id)->value('name');--}}
{{--                                    @endphp--}}
{{--                                        <td> {{ $role_name }} </td>--}}
                                    <th> {!!$row->activate()!!}</th>
                                    <td class="actions">
                                            ...
                                            <div class="row" style="margin-top: 20px">
                                                ...
                                                <div class="col-md-3">
                                                    <a href="{{route($route.'.edit',$row->id)}}">
                                                        <button type="button"
                                                                class="btn btn-info btn-custom waves-effect waves-light">
