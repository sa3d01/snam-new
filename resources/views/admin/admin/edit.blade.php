                    ...
                    <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role">
                                        @foreach($roles as  $role)
                                            <option value="{{$role->id}}" @if(\App\Models\AdminRole::where(['role_id'=>$role->id,'admin_id'=>$row->id])->first()) selected @endif>{{$role->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                        </div>
                        <div class="col-md-6">
                            <div class="white-box">
                                ...
                                <input name="image" type="file" id="input-file-now-custom-1" class="dropify" @if($row->image) data-default-file="{{asset('images/user/'.$row->image)}}" @else data-default-file="{{asset('images/user/admin.png')}}"  @endif/>
                                @if ($errors->has('image'))
