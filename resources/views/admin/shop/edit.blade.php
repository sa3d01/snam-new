                                ...
                                @foreach($json_fields as $label=>$value)
                                    @foreach($languages as $lang)
                                            <div class="form-group">
                                                ...
                                                @if($value=='note')
                                                    {!! Form::textarea($value.'_'.$lang->label, $row->$value[$lang->label], ['class'=>'form-control']) !!}
                                                @else
                                                    {!! Form::text($value.'_'.$lang->label, $row->$value[$lang->label], ['class'=>'form-control']) !!}
                                                @endif
                                                @if ($errors->has($value))
                            ...
                            @endif
                                ...
                                <div class="controls" style="overflow: auto">
                                    <div class="entry input-group col-xs-12">
                                        <input type="file"  name="images[]"  id="input-id"  class="file" data-preview-file-type="text" multiple="">
                                    </div>
